function getReceipt()
{
    //this initializes our string so it can get passed from function to function, growing line by line for a full receipt
    ...
    else if (selectedSize === "Insanely Large Pizza") {sizeTotal = 24;}
